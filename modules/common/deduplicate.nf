...
process DEDUPLICATE {
    ...
    picard MarkDuplicates I=${bam} O=${meta.sample}_${meta.replicate}.NoDup.bam M=${meta.sample}_${meta.replicate}_picard.log REMOVE_DUPLICATES=true
    
    samtools index ${meta.sample}_${meta.replicate}.NoDup.bam
    
    picard MarkDuplicates I=${bam} O=DupMark.bam M=${meta.sample}_${meta.replicate}_picard_1.log REMOVE_DUPLICATES=false
